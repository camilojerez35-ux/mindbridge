...
> Los campos marcados `⚑` deben completarse al constituir la empresa.
...
3. **Teleconsultas:** Sesiones de psicología por videollamada.
4. **Herramientas de autogestión:** Diario emocional, seguimiento de ánimo, ejercicios de bienestar.
5. **Protocolo de crisis:** Sistema de detección y derivación a recursos de emergencia.
...
- Las teleconsultas con psicólogos son un **complemento** al sistema de salud, no un reemplazo de atención de urgencias.
- **En caso de emergencia médica o riesgo de vida: llame al 123 (Emergencias Colombia) o a la Línea 106 (Salud Mental Bogotá).**
...
Los precios incluyen IVA cuando aplique, conforme a la legislación tributaria colombiana vigente.
...
- Usar la Plataforma para propósitos ilegales o no autorizados.
- Compartir credenciales de acceso con terceros.
- Intentar acceder a cuentas, datos o sistemas de otros usuarios.
- Publicar contenido ofensivo, difamatorio, ilegal o que infrinja derechos de terceros.
- Usar la Plataforma para contactar directamente a psicólogos por fuera de la misma.
- Acosar, amenazar o discriminar a profesionales o a otros usuarios.
- Intentar manipular el sistema de calificaciones de psicólogos.
- Realizar ingeniería inversa, descompilar o modificar la Plataforma.

El incumplimiento puede resultar en suspensión o eliminación de la cuenta **sin derecho a reembolso**.
...
## 8. PROTOCOLO DE CRISIS Y SEGURIDAD

La Plataforma incluye sistemas automatizados de detección de situaciones de riesgo. Cuando se detecte una situación de crisis:

1. Se mostrará una respuesta de apoyo inmediata con recursos de emergencia.
2. El incidente se registrará de forma anonimizada para supervisión clínica.
3. Si el usuario tiene un psicólogo asignado activo, este podrá ser notificado (según configuración del usuario).

**El usuario autoriza expresamente este protocolo al usar la Plataforma**, entendiendo que tiene por único propósito proteger su bienestar y el de terceros, conforme a la Ley 2460 de 2025.
...
Estos términos se rigen por las leyes de la **República de Colombia**. Las controversias se someterán a los jueces competentes de la ciudad de ⚑ [Ciudad], Colombia, o a mecanismos alternativos de resolución de conflictos (conciliación o arbitraje) ante la Cámara de Comercio de ⚑ [Ciudad].
