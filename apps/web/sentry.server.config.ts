// Sentry servidor — carga condicional: no falla si @sentry/nextjs no está instalado
try {
  ...
  Sentry.init({
    ...
    beforeSend(event: { request?: { data?: unknown; cookies?: unknown }; extra?: Record<string, unknown> }) {
