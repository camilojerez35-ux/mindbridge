...
export const metadata: Metadata = {
  title: 'Términos de Uso — MenteBridge Colombia',
  description: 'Términos y condiciones de uso de la plataforma MenteBridge Colombia.',
};
    ...
    <main className="max-w-3xl mx-auto px-5 py-16">
      ...
      <div className="space-y-8 text-sm text-gray-300 leading-relaxed">
        ...
        <Seccion titulo="1. Descripción del Servicio">
          <p>
            MenteBridge Colombia ofrece una plataforma digital de acompañamiento emocional que combina inteligencia artificial
          ...
          <div className="p-3.5 bg-amber-500/5 border border-amber-500/15 rounded-xl mt-3">
            ...
            <p className="text-xs text-gray-400">
              ...
              MenteBridge cuenta con protocolos de detección de crisis, pero no sustituye la intervención profesional inmediata.
            </p>
          </div>
        </Seccion>
        ...
        <Seccion titulo="3. Limitaciones de la IA">
          <p>
            La inteligencia artificial de MenteBridge aplica técnicas basadas en evidencia (TCC, ACT, mindfulness) para brindar
        ...
        <Seccion titulo="4. Planes y Pagos">
          <ul className="list-disc list-inside space-y-1.5 pl-2">
            ...
            <li>MenteBridge se reserva el derecho de modificar precios con 30 días de aviso previo por email</li>
          </ul>
        </Seccion>
        ...
        <Seccion titulo="6. Psicólogos de la Plataforma">
          <p>
            ...
            MenteBridge actúa como intermediario tecnológico; la responsabilidad clínica recae en el profesional tratante.
          </p>
        </Seccion>

        <Seccion titulo="7. Propiedad Intelectual">
          <p>
            El contenido, protocolos clínicos y software de MenteBridge son propiedad exclusiva de MenteBridge Colombia S.A.S.
        ...
        <Seccion titulo="8. Limitación de Responsabilidad">
          <p>
            MenteBridge no será responsable por daños indirectos, incidentales o consecuentes derivados del uso de la Plataforma.
        ...
        <Seccion titulo="9. Modificaciones">
          <p>
            MenteBridge puede modificar estos Términos en cualquier momento. Los cambios materiales serán notificados
